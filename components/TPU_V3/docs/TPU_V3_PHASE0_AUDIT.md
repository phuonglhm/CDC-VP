...
> **Superseded in part.** `TPU_V3_DECISION_RECORD.md` (approved 2026-08-08,
> decisions D1–D6) is the implementation authority where it and this file
> disagree. In particular decisions **P0-6** (SVM default), **P0-7** (MXU data
