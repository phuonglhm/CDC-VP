...
namespace sauria
{
    ...
    private:
        void dma_process()
        {
            ...
            // ----------------------------------------------------------------
            // 1. AXI Write Port Process (Dedicated write master - process write before read to resolve DRAM RAW hazard)
            // ----------------------------------------------------------------
            if (m_write_burst_cycles_left > 0)
            {
            ...
            // ----------------------------------------------------------------
            // 2. AXI Read Port Process (Round-Robin between CH0-CH3)
            // ----------------------------------------------------------------
            if (m_read_burst_cycles_left > 0)
            {
