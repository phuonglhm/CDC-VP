...
{
    template <
        int Y_DIM = 64, // Width of the boundary processing array
    ...
    private:
        ...
        void pipeline_process()
        {
            ...
            if (stage1_reg.valid)
            {
                ...
                next_stage2.channel_idx = stage1_reg.channel_idx;
            ...
            if (stage2_reg.valid)
            {
                ...
                next_stage3.channel_idx = stage2_reg.channel_idx;
                ...
                for (int l = 0; l < Y_DIM; l++)
                {
                    ...
                    if (lut_en)
                    {
                        ...
                        uint8_t lut_val = lut_ram[ram_idx][index];
