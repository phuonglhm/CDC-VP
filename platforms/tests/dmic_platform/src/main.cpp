...
int sc_main(int argc, char *argv[]) {
   const std::string config = get_opt(argc, argv, "-c", "platforms/tests/dmic_platform/configs/default.yaml");
   ...
   cdc::platforms::tests::dmic_platform::dmic_platform_top top("dmic_platform", config);
   if (!fw.empty()) {
